...
int main(int argc, char ** argv)
{
    ...
    CHECK(cudaHostAlloc(&in1, nBytes, cudaHostAllocMapped));
    CHECK(cudaHostAlloc(&in2, nBytes, cudaHostAllocMapped));
    CHECK(cudaHostAlloc(&out, nBytes, cudaHostAllocMapped));
